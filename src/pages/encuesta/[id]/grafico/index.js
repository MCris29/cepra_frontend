...
export default function SurveyGraphic() {
    ...
    const { data , error } = useSWR(`it/encuesta/${surveyId}`, fetcher, { shouldRetryOnError: false } );
                        ...
                        <div className={styles.containerSurveyGraphic}>
                            ...
                            >
                                <Box
                                    sx={{
                                        overflow: "auto",
                                        height: {desktop: "100%", laptop: "100%", tablet: "100%", mobile: "49%"},
                                        width: {desktop: "20%", laptop: "25%", tablet: "30%", mobile: "100%"}
                                    }}
                                ...
                                <Box
                                    sx={{
                                        overflow: "auto",
                                        marginLeft: {desktop: "1%", laptop: "1%", tablet: "1%", mobile: "0%"},
                                        marginTop: {desktop: "0%", laptop: "0%", tablet: "0%", mobile: "1%"},
                                        height: {desktop: "100%", laptop: "100%", tablet: "100%", mobile: "50%"},
                                        width: {desktop: "79%", laptop: "74%", tablet: "69%", mobile: "100%"}
                                    }}
                                            ...
                                            <>
                                                <Typography
                                                    sx={{
                                                        textAlign: "center",
                                                        fontWeight: "bold",
                                                        fontSize: {desktop: "2em", laptop: "1.5em", tablet: "1.17em", mobile: "1em"},
                                                    }}
                                                >
                                                    <span>{titleItem}</span>
                                                </Typography>
                                                        ...
                                                        <>
                                                            {
                                                                errordItem ? (
                                                                    ...
                                                                    <>
                                                                        <NotSelectedItem message={'Item no seleccionado'} />
                                                                    </>
                                                                )
                                                            }
                                                        </>
