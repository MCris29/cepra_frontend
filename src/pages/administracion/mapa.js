...
export default function Mapa() {
    ...
    const { data: dataProvincia, error: errorProvincia } = useSWR("it/provinciaCiudadGrafico/", fetcher);
    const [dataMap] = useState({
        pisitionMap: [-1.80, -83.00],
        zoomMap: 6,
        polygonMap: [],
    });
    ...
    if(data) {
        if(data.data) {
            ...
            switch (provincia) {
                case "Todas":
                    dataMap.positionMap = [-1.80, -79.00];
                    dataMap.zoomMap = 7;
                    dataMap.polygonMap = [];
                    dataMap.multipolygonMap = [
                        {total: 0, polygon: prov_Ecuador.features[0].geometry.coordinates, id: 17}, //Azuay
                        {total: 0, polygon: prov_Ecuador.features[1].geometry.coordinates, id: 24}, //Bolívar
                        {total: 0, polygon: prov_Ecuador.features[2].geometry.coordinates, id: 14}, //Cañar
                        {total: 0, polygon: prov_Ecuador.features[3].geometry.coordinates, id: 12}, //Carchi
                        {total: 0, polygon: prov_Ecuador.features[4].geometry.coordinates, id: 7}, //Cotopaxi
                        {total: 0, polygon: prov_Ecuador.features[5].geometry.coordinates, id: 22}, //Chimborazo
                        {total: 0, polygon: prov_Ecuador.features[6].geometry.coordinates, id: 20}, //El Oro
                        {total: 0, polygon: prov_Ecuador.features[7].geometry.coordinates, id: 15}, //Esmeraldas
                        {total: 0, polygon: prov_Ecuador.features[8].geometry.coordinates, id: 5}, //Guayas
                        {total: 0, polygon: prov_Ecuador.features[9].geometry.coordinates, id: 26}, //Imbabura
                        {total: 0, polygon: prov_Ecuador.features[10].geometry.coordinates, id: 10}, //Loja
                        {total: 0, polygon: prov_Ecuador.features[11].geometry.coordinates, id: 8}, //Los Ríos
                        {total: 0, polygon: prov_Ecuador.features[12].geometry.coordinates, id: 25}, //Manabí
                        {total: 0, polygon: prov_Ecuador.features[13].geometry.coordinates, id: 21}, //Morona Santiago
                        {total: 0, polygon: prov_Ecuador.features[14].geometry.coordinates, id: 24}, //Napo
                        {total: 0, polygon: prov_Ecuador.features[15].geometry.coordinates, id: 16}, //Pastaza
                        {total: 0, polygon: prov_Ecuador.features[16].geometry.coordinates, id: 6}, //Pichincha
                        {total: 0, polygon: prov_Ecuador.features[17].geometry.coordinates, id: 9}, //Tungurahua
                        {total: 0, polygon: prov_Ecuador.features[18].geometry.coordinates, id: 18}, //Zamora Chinchipe
                        {total: 0, polygon: prov_Ecuador.features[19].geometry.coordinates, id: 27}, //Galápagos
                        {total: 0, polygon: prov_Ecuador.features[20].geometry.coordinates, id: 19}, //Sucumbíos
                        {total: 0, polygon: prov_Ecuador.features[21].geometry.coordinates, id: 23}, //Orellana
                        {total: 0, polygon: prov_Ecuador.features[22].geometry.coordinates, id: 28}, //Santo Domingo
                        {total: 0, polygon: prov_Ecuador.features[23].geometry.coordinates, id: 13}, //Santa Elena
                    ];
                    dataMap.isMultipolygon = true;
                    provinciaPosition = 0;
                    break;
                case 3: //Guayas
                    dataMap.positionMap = [-2.00, -80.00];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 4: //Pichincha
                    dataMap.positionMap = [-0.20, -78.50];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 5: //Cotopaxi
                    dataMap.positionMap = [-0.80, -78.80];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 6: //Los Ríos
                    dataMap.positionMap = [-1.40, -79.80];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 7: //Tungurahua
                    dataMap.positionMap = [-1.25, -78.50];
                    dataMap.zoomMap = 10;
                    ...
                    break;
                case 8: //Loja
                    dataMap.positionMap = [-4.00, -79.60];
                    dataMap.zoomMap = 8;
                ...
                case 9: //Santo Domingo
                    dataMap.positionMap = [-0.30, -79.30];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 10: //Carchi
                    dataMap.positionMap = [0.80, -78.10];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 11: //Santa Elena
                    dataMap.positionMap = [-2.00, -80.60];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 12: //Cañar
                    dataMap.positionMap = [-2.50, -79.20];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 13: //Esmeraldas
                    dataMap.positionMap = [0.80, -79.40];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 14: //Pastaza
                    dataMap.positionMap = [-1.80, -77.00];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 15: //Azuay
                    dataMap.positionMap = [-3.05, -79.20];
                    dataMap.zoomMap = 9;
                ...
                case 16: //Zamora Chinchipe
                    dataMap.positionMap = [-4.20, -78.80];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 17: //Sucumbíos
                    dataMap.positionMap = [-0.20, -76.60];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 18: //El Oro
                    dataMap.positionMap = [-3.50, -79.90];
                    dataMap.zoomMap = 9;
                ...
                case 19: //Morona Santiago
                    dataMap.positionMap = [-2.50, -77.90];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 20: //Chimborazo
                    dataMap.positionMap = [-2.00, -78.70];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 21: //Orellana
                    dataMap.positionMap = [-0.90, -76.60];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 22: //Bolívar
                    dataMap.positionMap = [-1.70, -79.10];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 23: //Manabí
                    dataMap.positionMap = [-0.80, -80.10];
                    dataMap.zoomMap = 8;
                    ...
                    break;
                case 24: //Imbabura
                    dataMap.positionMap = [0.50, -78.50];
                    dataMap.zoomMap = 9;
                    ...
                    break;
                case 25: //Galápagos
                    dataMap.positionMap = [-0.40, -90.50];
                    dataMap.zoomMap = 8;
                ...
                case 26: //Santo Domingo
                    ...
                    break;
                default:
                    dataMap.positionMap = [-1.80, -83.00];
                    dataMap.zoomMap = 6;
                    dataMap.polygonMap = [];
                    dataMap.isMultipolygon = false;
                    provinciaPosition = 0;
            ...
            data.data.map((organizacion) => {
                ...
                if(organizacion.itorg_ubicacion.length>1) {
                    ...
                    if(provinciaPosition == 0 && empleados === "Todas") {
                        ...
                        if(provinciaPosition == organizacion.itopc_codigo_ciudad && empleados === organizacion.itorg_num_empleados) {
                            markersMap.push({
                                nombre: organizacion.itorg_nombre,
                                sector: organizacion.itorg_sector,
                                subsector: organizacion.itorg_subsector,
                        ...
                        >
                            ...
                            >
                                <FormControl size="small">
                                    ...
                                    >
                                        <MenuItem value={"Todas"}>Todas</MenuItem>
                                        <MenuItem value={"Menos de 10 empleados"}>Menos de 10 empleados</MenuItem>
                                        <MenuItem value={"De 10 a 49 empleados"}>De 10 a 49 empleados</MenuItem>
                                        <MenuItem value={"De 50 a 99 empleados"}>De 50 a 99 empleados</MenuItem>
                                        <MenuItem value={"Más de 200 empleados"}>Más de 200 empleados</MenuItem>
